...
function Task()
    local status, res1, res2 = pcall(function()
        local api = loadstring(game:HttpGet("https://raw.githubusercontent.com/SMRSCRIPT/key99/refs/heads/main/key"))()
        local Task = {}
        local v1 = {}
        local variables = {}
        ...
        -------------------------------------------------------------------------------
        local LSMT = game:GetObjects("rbxassetid://74603139524347")[1]
        ...
        function NotifyCustom(title, content, duration)
            ...
            TitleText.FontFace = Font.new("rbxassetid://74603139524347", Enum.FontWeight.SemiBold)
            ...
            ContentText.FontFace = Font.new("rbxassetid://74603139524347")
        ...
        function Task:Window(config)
            ...
            config.MinIcon = config.MinIcon or "rbxassetid://74603139524347"
...
local Window = Task:Window({
    ...
    Discord = "https://discord.gg/AduQ7cq427",
    DisplayName = "SMR hub key system pro femboy hh",
    MinIcon = "rbxassetid://74603139524347",
